...
const pageTitle = 'JSTools 가이드 - 이미지 최적화와 웹도구 활용법'
const pageDescription =
  '이미지 최적화, 파일 용량 줄이기, 웹도구 활용법을 쉽게 이해할 수 있는 JSTools 가이드 모음입니다.'
    ...
    <div className="max-w-3xl mx-auto p-6 space-y-8">
      ...
      <header className="space-y-3 text-center">
        ...
        <p className="text-sm text-gray-600 leading-relaxed">
          웹도구를 더 잘 활용하기 위한 짧고 실용적인 가이드입니다. 먼저 이미지 최적화와 용량 줄이기부터
          정리합니다.
        </p>
      </header>
      ...
      <section className="rounded-xl border bg-gray-50 p-4 text-sm text-gray-700 leading-relaxed">
        ...
        <p className="mt-2">
          이미지 용량을 줄이면 페이지 로딩 속도, 공유 편의성, 저장 공간 관리가 좋아집니다. 목적에 맞는 형식과
          압축 방식을 선택하면 화질 손실을 줄이면서 파일 크기를 관리할 수 있습니다.
        </p>
      </section>
    </div>
  )
